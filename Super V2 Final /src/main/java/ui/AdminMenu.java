...
public class AdminMenu {
    public static void display(Scanner scanner, BookService bookService, BorrowService borrowService, UserService userService) {
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    UserMenu.viewAndBorrowBooks(scanner, bookService, borrowService, new User("admin", "admin123", true));
                    break;
                case 4:
                    UserMenu.returnBooks(scanner, bookService, borrowService, new User("admin", "admin123", true));
                    break;
                case 5:
                    UserMenu.checkLoanHistory(scanner, borrowService, new User("admin", "admin123", true));
                    break;
                case 6:
                    return;
                default:
